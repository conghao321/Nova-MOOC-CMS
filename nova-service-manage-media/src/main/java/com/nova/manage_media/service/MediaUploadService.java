package com.nova.manage_media.service;
/*
 * @Author:conghao
 * @description:
 */
...
import com.nova.framework.domain.media.response.MediaCode;
...
import com.nova.manage_media.config.RabbitMQConfig;
import com.nova.manage_media.dao.MediaFileRepository;
...
public class MediaUploadService {
    ...
    @Value("${nova-service-manage-media.upload-location}")
    String upload_location;

    @Autowired
    RabbitTemplate rabbitTemplate;

    @Value("${nova-service-manage-media.mq.routingkey-media-video}")
    ...
    /**
     * Before the upload the file, it checks file exists or not
     *
     * Get the path by file' md5
     * Rules：
     * First level：First char of MD5
     * Second Level：Second char of MD5
     * Third Level：Third char of md5
     * File's name = MD5+ extension name.
     *
     * @param fileMd5  file's md5
     * @param fileExt  extension name.
     * @return file's path
     */
